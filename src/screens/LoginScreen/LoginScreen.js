...
import { colors } from "../../Lib/constants/themeColors/ThemeColors";
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      <StatusBar hidden={true} />
        ...
        >
          ...
          <View
            style={{
              backgroundColor:colors[theme].thumbNailBg,
          ...
          >
            <Text
              style={{
                ...
                textAlign: "center",
                  ...
                  color:colors[theme].primaryTextColor,
            ...
            >
              <TextInput
                ...
                type="Email"
                value={email}
                placeholderTextColor={colors[theme].placeHolderColorText}
            ...
            >
              ...
              >
                <Text style={{
                  color:colors[theme].placeHolderColorText
